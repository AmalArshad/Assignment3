...
public class MainActivity extends AppCompatActivity {
    ...
    String cameraPermisson[];
    String storagePermission[];
    private int PICK_PHOTO_FOR_AVATAR;
    ...
    private void pickFromGallery() {  Intent intent = new Intent(Intent.ACTION_GET_CONTENT);
        intent.setType("image/*");
        startActivityForResult(intent, PICK_PHOTO_FOR_AVATAR);;}

    @RequiresApi(api = Build.VERSION_CODES.M)
    private void requestCameraPermission() { requestPermissions(cameraPermisson,CAMERA_REQUEST);}
    ...
    private static byte[] imageViewToBy(ImageView avatar) {
